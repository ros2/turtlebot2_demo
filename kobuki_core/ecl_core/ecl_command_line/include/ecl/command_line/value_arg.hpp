/**
 * @file /include/ecl/command_line/value_arg.hpp
 *
...
/**
 * @brief TClap class internally used for extracting value args.
 *
 * This class is used to extract a value from an argument.
 * It is used because we need a special implementation to
 * deal with std::string and making a specialised function
 * puts it in the T segment, thus generating link errors.
 * Having a specialised class makes the symbols weak.
...
/**
 * @brief TClap class internally used for string handling.
 *
